...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <span style="display:block;padding:10px 30px 0px;background:#f7f7f7;text-align:right">
            회사명 : <?php echo $wr_1 ?>
        </span>
        <span style="display:block;padding:10px 30px 0px;background:#f7f7f7;text-align:right">
            이름 : <?php echo $wr_name ?>
        </span>
        <span style="display:block;padding:10px 30px 0;background:#f7f7f7;text-align:right">
            연락처 : <?php echo $wr_3 ?>
        </span>
