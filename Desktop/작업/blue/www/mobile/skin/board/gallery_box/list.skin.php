                ...
                <div class="gall_con">
                    <div class="gall_boxa">
						...
						<em class="iconPs bo_tit">
							...
							if ($youtubeID[2] == "youtu.be")  echo "<i class=\"fa fa-youtube-play fts13px\"><span class=\"sound_only\">유투브영상</span></i> ";
                            ?>
						</em>
						<?php
                            ...
                            if($thumb['src']) {
								...
								if($youtubeID[2] == "youtu.be") {
									$img_content = '<i class="youtube_img"><sup style="background-image:URL(https://img.youtube.com/vi/'.$youtubeID[3].'/sddefault.jpg" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w='.$board['bo_gallery_width'].'&h='.$board['bo_gallery_height'].'" alt="youtube image spacer"></i></sub></i>
								';
								} else {
                         ...
                         ?>
						<em class="gall_info">
							<span style="font-size:12px; padding:8px 16px; border:1px solid #fff">+ 자세히보기</span>
							<!--span style="font-size:16px"> [<?php echo $list[$i]['ca_name'] ?>]</span><br>
							<span class="gall_date" style="font-size:16px">  <?php echo $list[$i]['subject'] ?></span--> 
						</em>
                        </a>
                    </div>
