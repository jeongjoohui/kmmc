    ...
    <?php } ?>
	 ...
	 <div class="bo_w_tit write_div">
		 <label for="wr_1" class="sound_only">업체명<strong>필수</strong></label>
          <div id="autosave_wrapper write_div">
          <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input required" size="50" maxlength="255" placeholder="업체명">
	      <div>
     </div>
	 ...
	 <div class="bo_w_tit write_div">
		 <label for="wr_3" class="sound_only">연락처</label>
          <div id="autosave_wrapper write_div">
          <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" class="frm_input full_input required" size="50" maxlength="255" placeholder="연락처">
	      <div>
     </div>
    <div class="write_div">
