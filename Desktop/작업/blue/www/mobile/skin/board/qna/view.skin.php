...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
	<div>업체명: <?php echo $view['wr_2'] ?></div>
	<div>업종: <?php echo $view['wr_6'] ?></div>
	<div>담당자: <?php echo $view['wr_name'] ?></div>
	<div>연락처: <?php echo $view['wr_4'] ?></div>
	<div>이메일: <?php echo $view['wr_email'] ?></div>
	<div>프로젝트분야: <?php echo $view['wr_7'] ?></div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           ...
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 질문등록</a></li><?php } ?>
        </ul>
