...
?>
	...
	<div class="btn_estimate">
		<center>
			<a href="<?php G5_BBS_URL ?>/write.php?bo_table=estimate"><img src="../img/btn_proposal.png"></a>
		</center>
	</div><!-- // #container 닫음 -->
	<?php }  //인덱스에서 사용하지 않음?>
	<aside id="sideBar">
...
<!--<button type="button" id="top_btn" class="fa fa-arrow-up" aria-hidden="true"><span class="sound_only">페이지 상단으로 이동</span></button> 전화안내 때문에 필요없음-->
