...
<div class="qnaLat">
    <h2 class="qnaLatTit"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>"><?php echo $bo_subject ?> <u></u></a></h2>
    <ul>
        ...
        <li>
			<a href="<?php echo $list[$i]['href'] ?>">
				...
				<?php } else {?>
					...
					<span class="qnaIco qnaIco2"><i class="fa fa-smile-o" aria-hidden="true"></i> 수정완료</span>
					<?php } else {?>
