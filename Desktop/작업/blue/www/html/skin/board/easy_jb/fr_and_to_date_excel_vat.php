...
if (!$is_admin) {
   exit;
	...
	if ($migyeol == '미결제') {
		$sql .= " AND  wr_5 = '' "; // 결제일이 NULL 이면 미결제처리
			}
...
<?php
	...
	echo "</head><body>";
 if ($migyeol == "") {
    echo "<font style='font-weight:bold'>[ 부가가치세 ]</font>";
 		} else {
 	echo "<font style='font-weight:bold'>[ 미결제 내역 ]</font>";
	 	}
    echo "<table border=1 style='font-family:돋움; font-size:10pt;'>";
    echo "<tr align='center'><td>① 날짜</td><td>② 거래내용</td><td>③ 거래처</td><td colspan='2'>④ 수입</td><td colspan='2'>⑤ 비용</td><td colspan='2'><font color='cccccc'>⑥ 고정자산 증감<font></td><td>⑦ 비고</td></tr><tr align='center'><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>금액</td><td>부가세</td><td>금액</td><td>부가세</td><td><font color='cccccc'>금액</font></td><td><font color='cccccc'>부가세</font></td><td>&nbsp;</td></tr>\n";
