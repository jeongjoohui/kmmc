...
<button type="button" class="cmt_btn"><i class="fa fa-commenting-o" aria-hidden="true"></i> 관리메모</button>
...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header style="z-index:<?php echo $cmt_sv; ?>">
            ...
            <span class="bo_vc_hdinfo"><i class="fa fa-clock-o" aria-hidden="true"></i> <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['datetime'])) ?>"><?php echo date("Y-m-d", strtotime($view[wr_datetime]))?></time>&nbsp;</span>
            <?php
    ...
    <?php } ?>
    <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty">관리메모가 없습니다.</p><?php } ?>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="내용" placeholder="관리메모를 입력해주세요" 
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
            ...
            <input type="submit" id="btn_submit" class="btn_submit" value="작성완료">
        </div>
    </div>
    </form>
</aside>
