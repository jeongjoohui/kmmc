...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc" style="margin-top:-30px;">
        ...
        <table width="100%">
			<tr>
				<td height="30">
				&nbsp;&nbsp;<font color="green">회계날짜</font> : <?php echo date("Y-m-d", strtotime($view['wr_1']));?>
				</td>
				<td colspan="3">
				&nbsp;&nbsp;<font color="green">거래분류</font> : <?php echo $view['ca_name']?> (<?php echo $view['wr_8'];?>)
				</td>
			</tr>
			<tr><td colspan="3" height="1" bgcolor="#e7e7e7"></td></tr>
			<tr>
    			<td height="30">
       			 &nbsp;&nbsp;<font color="green">거 래 처</font> : <?php echo $view['wr_subject'];?>
				</td>
				<td colspan="2">
        		&nbsp;&nbsp;<font color="green">거래내용</font> : <?php echo $view['wr_2'];?>
    			</td>
			</tr>
			<tr><td colspan="3" height="1" bgcolor="#e7e7e7"></td></tr>
			<tr>
    			<td height="30">
        		&nbsp;&nbsp;<font color="green">공급금액</font> : 
			<? if($view[ca_name] == '매출') { ?>
				<font color="blue">
			<?php echo number_format($view['wr_3']);?>
			<? } else { ?>
            	<font color="red">
			<?php echo number_format($view['wr_3']);?>
        	<? } ?>
				...
				<td>
       			&nbsp;&nbsp;<font color="green">부가세액</font> : 
        	<? if($view[ca_name] == '매출') { ?>
            	<font color="blue">
			<?php echo number_format($view['wr_4']);?>
        	<?php } else { ?>
            	<font color="red">
			<?php echo number_format($view['wr_4']);?>
        	<?php } ?>
				...
				<td>
				&nbsp;&nbsp;<font color="green">결제날짜</font> : 
	    	<?php if($view['wr_5'] == '') { ?>
				<font color="cccccc"><?php echo $view['wr_5'];?></font>
					<?php } else { ?>
				<?php echo date("Y-m-d", strtotime($view['wr_5']));?>
			<?php } ?>
    			</td>
			</tr>
            <tr><td colspan="3" height="1" bgcolor="#e7e7e7"></td></tr>
	        <tr>
        		...
        		&nbsp;&nbsp;<font color="#666666">검증코드 : <?//=$first_day?><?php echo $view['wr_7'];?></font>
                </td>
			</tr>
		<tr><td colspan="3" height="1" bgcolor="#e7e7e7"></td></tr>
	</table>
