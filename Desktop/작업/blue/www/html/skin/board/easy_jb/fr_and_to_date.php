...
<tr>
    <td colspan="3">
        <img src="./img/title_gigan.png" width="147" height="26" />
    </td>
</tr>
<tr>
    <td colspan="3" align="right">
        ...
        <a href="<?php echo $board_skin_url ?>/no_ok.php?bo_table=<?php echo $bo_table?>"><img src="./img/bt_migyeol.png" width="77" height="18" border="0" />&nbsp; <a href="<?php echo $board_skin_url ?>/fr_and_to_date_excel_vat.php?bo_table=<?php echo $bo_table?>&fr_date=<?php echo $fr_date?>&to_date=<?php echo $to_date?>&gubun=<?php echo $gubun?>"><img src="./img/excel_vat.png" width="99" height="18" border="0" /></a>&nbsp; <a href="<?php echo $board_skin_url ?>/fr_and_to_date_excel_income.php?bo_table=<?php echo $bo_table?>&fr_date=<?php echo $fr_date?>&to_date=<?php echo $to_date?>&gubun=<?php echo $gubun?>"><img src="./img/excel_income.png" width="99" height="18" border="0" /></a>&nbsp;<a href="#"><img src="./img/bt_print.png" width="49" height="18" border="0" onclick="window.print()" /></a>
         ...
         echo "
            <tr>
                <td colspan='12'>
                    ...
                    기간별조회 : [$fr_date~$to_date] Page $subpage/$printpage</h6>
                </td>
            </tr>
        ";
        } else {
...
<tr><td>
    ...
    기간별내역 합계 : [<?php echo $fr_date?> ~ <?php echo $to_date?>]
	</h5>
</td></tr>
<tr>
    <td width="50%">&nbsp;</td>
