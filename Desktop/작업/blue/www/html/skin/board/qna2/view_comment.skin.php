...
<!-- 답변 시작 { -->
<hr class="dashHr">
<button type="button" class="cmt_btn"><i class="fa fa-commenting-o" aria-hidden="true"></i> 답변목록 <i class="fa fa-chevron-up" aria-hidden="true"></i><i class="fa fa-chevron-down" aria-hidden="true"></i> </button>
<section id="bo_vc">
    <h2>답변목록</h2>
    <?php
    $cmt_amt = count($list);
