...
<section id="bo_w">
	...
	<?php if ($is_admin) { ?><a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_b02 btn" style="width:100%;text-align:center;"><b>관리자전용버튼</b> : 폼메일 관리목록 바로가기</a><br><div style="color:#ff6600;">본 버튼은 관리자에게만 보이며 <b> [ <?php echo $board[bo_subject]?> ] </b> 게시판의 목록 및 상세보기 페이지는 관리자만 확인 가능합니다.</div><?php } ?>
    ...
    <div class="bo_w_ico write_div">
        ...
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" size="50" placeholder="연락처">
    </div>
    ...
    <div class="write_div_privacy">
		...
		<a href="#" data-featherlight="<?php echo G5_THEME_URL ?>/privacy.php .term_area" data-featherlight-type="ajax"><b>개인정보처리방침</b> 자세히 보기</a>
    </div>
    ...
    <div class="btn_confirm write_div">
		<button type="reset" class="btn_cancel btn">초기화</button>
        <input type="submit" value="보내기" id="btn_submit" accesskey="s" class="btn_submit btn">
    </div>
    </form>
