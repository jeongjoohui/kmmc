...
<div id="sch_result">
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        <h2><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><?php echo $bo_subject[$idx] ?> 내 결과</a></h2>
        <ul>
        <?php
        for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
         ...
         ?>
            ...
            <li>
                ...
                <p>
					<?php echo cut_str(strip_tags($list[$idx][$i]['content']),150," . . . ") ?>
				</p>
                <div class="sch_info">
