...
최고의 전문가들이 머리를 맞대고 당신의 블루오션을 만들어드립니다.</dd>
       ...
       <ul>
           <a href="product_01.php"><li class="bn1">
           ...
           <a href="product_02.php"><li class="bn2">
                <div class="box actionImg8">  
				    <span class="more">+</span>
           ...
           <a href="product_03.php"><li class="bn3 margin-none">
                <div class="box actionImg8">  
				    <span class="more">+</span>
           ...
           <a href="product_04.php"><li class="bn4">
                <div class="box actionImg8">
				    <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <div class="rong_txt">
                                ...
                                <span class="desc">스마트폰 4천만시대, 파급력이 폭발적인<br>모바일을 통한 마케팅 전략 노출 홍보를 말합니다.
                                </span>
                            </div>
                        </div>
                    </div>
           ...
           <a href="product_05.php"><li class="bn5">
               <div class="box actionImg8"> 
			        <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <span class="desc">빅데이터 기반 사용자의 방문기록을 체크하여<br>광고효율을 높여주는 마케팅입니다.
                            </span>
                        </div>
                    </div>
               </div>
           ...
           <a href="product_06.php"><li class="bn6 margin-none">
                <div class="box actionImg8"> 
				    <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <span class="desc">페이스북/인스타그램/유튜브 등<br>다양한 SNS를 활용하는 광고입니다.
                            </span>
                        </div>
                    </div>
               </div>
		   ...
		   <a href="product_07.php"><li class="bn7">
                <div class="box actionImg8"> 
				    <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <span class="desc">기업의 PR 홍보 브랜드 상품 서비스 재화 등의<br>내용을 언론 매체 특히, 기사의 형식으로<br>게재하는 마케팅 방법을 말합니다.
                            </span>
                        </div>
                    </div>
               </div>
		   ...
		   <a href="product_08.php"><li class="bn8">
                <div class="box actionImg8"> 
				    <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <span class="desc">특정 기업의 협찬을 대가로 영화나 드라마에서<br>해당 기업의 상품이나 브랜드 이미지를<br>끼워넣는 광고 기법을 말합니다.
                            </span>
                        </div>
                    </div>
               </div>
		   ...
		   <a href="product_09.php"><li class="bn9 margin-none">
                <div class="box actionImg8"> 
				    <span class="more">+</span>
                    ...
                    <div class="back">
                        <div class="back_inner">
                            ...
                            <span class="desc">지하철 광고, 버스 광고 등의<br>
                                대중교통을 이용한 마케팅 기법을 말합니다. 
                            </span>
                        </div>
                    </div>
               </div>
