...
<hr>
<!-- 콘텐츠 시작 { -->
<div id="page_title" class="subTopBg_00">
...
<div id="ctWrap">
	...
	<div id="container">
		...
		<!-- 메인화면 최신글 시작 -->
		<div class="contents">
			<div class="company_section01">
				<h1>
					<span>Blueocean b&amp;m</span>
					<strong>블루오션비엔엠</strong>
				</h1>
				<br>
				<dl>
					<!--dt>Pixel Frame Inspiration Creative Agency</dt-->
					<dd>
						10년이라는 적지 않은 시간 동안 다양한 병원 마케팅 프로젝트를 통해 수많은 고객님들을 만나고 수많은 프로젝트를 성공적으로 마무리하였습니다.<br class="br_none"/>
						<em>하루가 다르게 변화하는 온-오프라인 환경에서 적극적인 자세로 변화를 민감하게 캐치하고 유연한 마케팅을 실시하여야 최상의 성과</em>를 낼 수 있습니다.<br class="br_none"/><br class="br_none"/>
						(주)블루오션비엔엠은 병원 전문 마케팅 업체로써 클라이언트 한 분 한 분의 병.의원기업을 마치 내 병원같이 생각하며<br class="br_none"/>
						<em>시시각각 변화하는 트렌드에 발맞추어 항상 최상의 마케팅 효과를 낼 수 있도록 맞춤형 제안</em>을 드리고 있습니다.<br class="br_none"/>
						또한, 단순히 광고를 진행하는 회사가 아니라 <em>기획부터 전략수립 시행은 물론, 성과 분석과 후속 조치까지 토탈 솔루션</em>을 제시하여<br class="br_none"/>
						고객님의 만족과 이익이 극대화 되도록 노력하겠습니다. 다년간의 경력과 경험을 바탕으로 삼아 최고의 전문 인력들이 분석하고 실행하는<br class="br_none"/>
						(주)블루오션비엔엠의 병원 맞춤형 토탈 마케팅 솔루션을 통해 고객의 이익이 나의 만족이 될 수 있도록 미래를 향해 나아가겠습니다.
					</dd>
				</dl>
			</div>
			<div class="company_section02">
				<h1>
					<span>Our philosophy</span>
					우리의<strong> 철학</strong>
				</h1>
				<img src="../img/br.png" alt="">
				<p>
					<em>병원 마케팅의 시작은 원장님을 알리는 것 부터 시작합니다.</em><br class="br_none"/>
					단지 외형만 화려한 병원의 브랜드를 넘어서 내원 환자의 목적과 사용자 경험에 대한 본질을 생각하고 전략적으로 연구합니다.<br class="br_none"/>
					우리는 <em>마케팅 프로젝트에 대한 이해와 공감을 중요시하며 클라이언트의 1차적 만족을 넘어서 소비자의 만족까지 생각하는 통합 마케팅 그룹</em>입니다.<br class="br_none"/>
					원장님과 병원 브랜드의 목표를 향상시키기 위해 우리와 함께하세요.
				</p>
			</div>
			<div class="company_section03">
				<h1>
					<span>Our mission</span>
					우리의<strong> 역할</strong>
				</h1>
				<ul>
					<li>
						<img src="../img/com_icon1.png">
						<dl>
							<dt>Iearn</dt>
							<dd>마케팅 전략 기술을 끊임없이 연구하고<br/>실험하며 성장을 추구합니다.</dd>
						</dl>
					</li>
					<li>
						<img src="../img/com_icon2.png">
						<dl>
							<dt>Plan</dt>
							<dd>나침반 없이 망망대해를 향해하지 않습니다.<br/>정확한 목적과 방향을 계획합니다.</dd>
						</dl>
					</li>
					<li>
			...
			<div class="company_section04">
				<h1>
					<span>What we do</span>
					우리가<strong> 하는 일</strong>
				</h1>
				<div class="box">
					<ul>
						<li>
							<i class="fa fa-bar-chart fa-33"></i>
							<dl>
								<dt>종합 컨설팅</dt>
								<dd>데이터를 분석하여<br>광고 방향을 제시 합니다.</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-desktop fa-33"></i>
							<dl>
								<dt>웹사이트</dt>
								<dd>웹사이트 신규 및 리뉴얼 구축 합니다.<br>&nbsp;</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-briefcase fa-33"></i>
							<dl>
								<dt>공식대행사</dt>
								<dd>네이버,다음,카카오<br>공식 대행사를 맡고 있습니다.</dd>
							</dl>
						</li>
					</ul>
					<ul>
						<li>
							<i class="fa fa-bullhorn  fa-33"></i>
							<dl>
								<dt>바이럴</dt>
								<dd>블로그,카페,지식인등<br>바이럴 마케팅을 진행 합니다.</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-laptop fa-33"></i>
							<dl>
								<dt>온라인 디스플레이</dt>
								<dd>온라인 리타겟팅 광고를 진행합니다.<br>&nbsp;</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-building-o fa-33"></i>
							<dl>
								<dt>PPL마케팅</dt>
								<dd>기업의 제품을 자연스럽게 노출시킵니다.<br>&nbsp;</dd>
							</dl>
						</li>
					</ul>
					<ul>
						<li>
							<i class="fa fa-subway fa-33"></i>
							<dl>
								<dt>대중교통 마케팅</dt>
								<dd>지하철,버스,역사 등에 노출 합니다.</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-tasks fa-33"></i>
							<dl>
								<dt>프로그램 개발</dt>
								<dd>마케팅 종합 프로그램을 개발 합니다.</dd>
							</dl>
						</li>
						<li>
							<i class="fa fa-tags fa-33"></i>
							<dl>
								<dt>자사 브랜드</dt>
								<dd>자체적인 브랜드 사업을 진행 합니다.</dd>
							</dl>
						</li>
					</ul>
				</div>        
		...
		$(function(){
			$("#btn a").click(function(){
				$(".computer-item").html("<img src='../img/computer_img"+$(this).data("id")+".png' alt=''></div>");
