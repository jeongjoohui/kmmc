...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL ?>/board.common.css?ver=<?php echo date("Hi");?>">
<link rel="stylesheet" href="<?php echo G5_JS_URL ?>/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL ?>/mobile.css?ver=<?php echo date("Hi");?>">
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL ?>/contents.css?ver=<?php echo date("Hi");?>">
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery-1.11.0.min.js"></script>
...
<script src="<?php echo G5_THEME_URL ?>/plugin/shuffleLetters/jquery.shuffleLetters.min.js"></script>
