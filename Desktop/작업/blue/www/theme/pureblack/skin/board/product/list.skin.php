...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css?v=32">', 0);
?>
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
						...
						<div class="gall_textMv">
							<em>
								<?php echo cut_str(strip_tags($list[$i][wr_1]),100," . . . ") ?>
							</em>
							<a href="<?php echo $list[$i]['href'] ?>" class="btn_b02"><i class="fa fa-search-plus"></i> 자세히 보기</a>
						</div>
