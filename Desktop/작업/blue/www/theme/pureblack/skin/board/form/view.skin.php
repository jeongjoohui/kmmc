...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">연락처</span><strong><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $view['wr_1'] ?></strong> <br><br>
        <span class="sound_only">이메일</span><strong><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $view['wr_email'] ?></strong>
    </section>
