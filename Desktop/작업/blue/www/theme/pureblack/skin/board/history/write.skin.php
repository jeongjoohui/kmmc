...
<section id="bo_w">
	...
	<div class="bo_w_info"><span>(공지에 체크하시면 연혁 리스트 최상단에 안내맨드 등록이 가능합니다. / 년도입력란에는 제목을 입력해 주세요.)</span></div>
    <?php } ?>

    <div class="bo_w_tit write_div">
        <label for="wr_subject" class="sound_only">년도<strong>필수</strong></label>
        
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="년도를 입력하세요">
    ...
    <div class="write_div">
		...
		<div class="bo_w_info"><span>(내용은 엔터로 구분해 주세요.)</span></div>
